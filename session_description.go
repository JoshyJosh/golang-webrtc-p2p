...
// leaving this in case it comes in handy originally from examples/internal/signal
...
// adapted from pion examples/reflect
func getSDP(browserRTCSessionDescription string) (serverRTCSessionDescription string) {
